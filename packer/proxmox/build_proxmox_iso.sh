...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_windows10_cloudinit.iso answer_files/10_proxmox_cloudinit scripts
...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_windows10_cloudinit_uptodate.iso answer_files/10_proxmox_cloudinit_uptodate scripts
...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_winserver2016_cloudinit.iso answer_files/2016_proxmox_cloudinit scripts
...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_winserver2019_cloudinit.iso answer_files/2019_proxmox_cloudinit scripts
...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_winserver2019_cloudinit_uptodate.iso answer_files/2019_proxmox_cloudinit_uptodate scripts
